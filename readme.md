...
### Pages
 ...
 - Profile/Upload page
    ...
    - uploaded files will be sent to either s3(if need to be simple), or maybe sent to sqs so the content can be sent to different lambda or possibly to hit an api endpoint from a python app that will convert the media files and then send it to a s3 bucket
 - Content
